...
Klasyfikacja dotycząca tematów przeprowadzana była jedynie na danych, które pole topics przyjmowało jedną z wartości: gold, cocoa, sugar, coffe, grain. Zbiory testowe stanowiły 50\% artykułów. \newline
...
\begin{itemize}
	...
	\item 
	\item 
	\item Metoda k-NN źle sobie radzi z przypisaniem tekstów do autorów
\end{itemize}
